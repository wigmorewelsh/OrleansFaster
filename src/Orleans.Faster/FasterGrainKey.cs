...
namespace Orleans.Persistence.Faster
{
    ...
    internal class FasterGrainKey
    {
        ...
        public FasterGrainKey(long key, string keyExtension)
        {
            N0Key = 0;
            N1Key = key;
        ...
        public FasterGrainKey(Guid key, string keyExtension)
        {
        ...
        public FasterGrainKey(string key)
        {
            StringKey = key;
            N0Key = 0;
            N1Key = 0;
